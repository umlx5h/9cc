...
assert 11 'main() { a=b=3+2*4; return a; }'
assert 3 'main() { a=b=foo=3; return b; }'

assert 4 'main() { return1234 = 4; return return1234; }'
...
assert 150 'main() { a=10; if (1) a = a + 5; else a = a + 10; if (0) return a + 10; else a * 10; }'
...
assert 6 'main() { a = ret3(); return a * 2; }'
